...
export function WhatsappFab() {
  ...
  return (
    <a
      ...
      className="fixed bottom-0 right-5 z-40 inline-flex items-center gap-2 border border-b-0 border-rule bg-surface px-4 py-2.5 transition-colors hover:bg-surface-2 sm:right-8"
    >
      <svg viewBox="0 0 24 24" className="size-4 text-success" fill="currentColor" aria-hidden>
      ...
      <span className="label">Escribinos</span>
    </a>
  );
}
