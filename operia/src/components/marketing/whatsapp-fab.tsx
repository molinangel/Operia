...
/** Botón flotante de WhatsApp: convierte bastante más que un formulario de contacto. */
export function WhatsappFab() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-40 inline-flex size-13 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_8px_24px_-4px_rgba(37,211,102,0.5)] transition hover:scale-105 active:scale-95"
